          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: Text(
                  "We've sent a One-Time Password (OTP) to ${widget.email}. Please check your inbox, and if you don't find it there, kindly look in your spam folder",
                  style: TextStyle(
              ...
              CustomFilledButton(
                ...
                onPressed: () {
                  if (formKey.currentState!.validate()) {
                    ...
                    // Get.offAll(() => const SelectPlatformView());
                  }
                },
                child: const Text(
                  'Verify',
              ...
              Row(
                ...
                children: [
                  InkWell(
                    onTap: () {
                      provider.resendEmailVerification(
                        email: widget.email,
                      );
                    },
                    child: Text(
